/*
 * UndeadInvasion Undead brain
 * 
 * This script handles anything related to the AI itself. The AI is fairly 
 * simple. Undead brains are either in invading mode, or targeting mode. In 
 * the first case, the undead will target the nearest survivor spawn. In the 
 * second case, the undead will chase a survivor or animal as long as it is 
 * within range. If the undead stumbles across a survivor or animal while in 
