...
namespace Base {
  ...
  class AudioManager {
    ...
    CMixer@ mMixer;
    Base::AudioSoundtrack@[] mSoundtracks; //Not allowed to refer a whole array for some reason
    ...
    AudioManager(Base::AudioSoundtrack@[] soundtracks) {
    ...
    int getPlayingCount(string groupName = "") {
      ...
      //Otherwise
        ...
        Base::AudioSoundtrack@ soundTrack;
