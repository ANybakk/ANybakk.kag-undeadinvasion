...
namespace ANybakk {
  ...
  class AudioManager {
    ...
    CMixer@ mMixer;
    ANybakk::AudioSoundtrack@[] mSoundtracks; //Not allowed to refer a whole array for some reason
    ...
    AudioManager(ANybakk::AudioSoundtrack@[] soundtracks) {
    ...
    int getPlayingCount(string groupName = "") {
      ...
      //Otherwise
        ...
        ANybakk::AudioSoundtrack@ soundTrack;
