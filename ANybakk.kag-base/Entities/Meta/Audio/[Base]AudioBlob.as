...
namespace Base {
  ...
  namespace AudioBlob {
    ...
    void onInit(CBlob@ this) {
      ...
      Base::AudioManager audioManager(Base::AudioVariables::SOUND_TRACKS);
        ...
        if(s_soundon != 0 && s_musicvolume > 0.0f) {
          ...
          if(rules.isMatchRunning()) {
            ...
            if(!this.hasTag("matchWasStarted")) {
              ...
              if(Base::AudioVariables::MATCH_START_SOUND != "") {
              
                //Play game start sound
                //TODO: Move to a sprite script?
                Sound::Play(Base::AudioVariables::MATCH_START_SOUND);
