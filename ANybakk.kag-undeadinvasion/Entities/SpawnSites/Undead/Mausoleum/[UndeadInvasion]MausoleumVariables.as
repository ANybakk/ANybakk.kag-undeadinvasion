/*
 * UndeadInvasion Mausoleum variables
 * 
...
#include "[UndeadInvasion]MausoleumSpriteMode.as";

namespace MausoleumVariables {

  //Define a besieged alert time-out of 3 seconds
  const u8 SPRITE_MODE_DEFAULT = MausoleumSpriteMode::MODE_CLOSED;
