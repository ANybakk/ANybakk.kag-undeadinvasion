...
namespace ANybakk {
  ...
  class UndeadBrain {
    ...
    UndeadBrain(UndeadVariables pVariables) {
    ...
    void onInit(CBrain@ this) {
      ...
      blob.set_u8("brain_delay", mVariables.BRAIN_DELAY);
    ...
    void onTick(CBrain@ this) {
      ...
      if(brainDelay == 0) {
        ...
        //Reset delay tracker
        brainDelay = mVariables.BRAIN_DELAY;
        ...
        if(brainMode == UndeadBrainMode::MODE_INVADING) {
          ...
          blob.getMap().getBlobsInRadius(blob.getPosition(), mVariables.BRAIN_DETECT_RADIUS, @potentialTargets);
          ...
          for(uint i = 0; i < potentialTargets.length && !targetFound; i++) {
            ...
            if(potentialTarget.getTeamNum() != blob.getTeamNum() && (potentialTarget.hasTag("CreatureBlob::isMadeOfFlesh") || potentialTarget.hasTag("flesh"))) {
          ...
          if(targetFound) {
            ...
            UndeadBlob::pressMovementKeys(blob, target);
        ...
        //Check if mode is targeting mode
          ...
          //Otherwise, target is valid
            ...
            if(UndeadBlob::isWithinChasingRange(blob, target)) {
          
              //Determine attack frequency
              f32 attackFrequency = mVariables.BRAIN_ATTACK_FREQUENCY * getTicksASecond();
              ...
              bool isWithinMeleeRange = CreatureBlob::isWithinMeleeRange(blob, target);
              ...
              if(isTimeToAttack && isWithinMeleeRange) {
                ...
                f32 attackDamage = mVariables.ATTACK_DAMAGE;
