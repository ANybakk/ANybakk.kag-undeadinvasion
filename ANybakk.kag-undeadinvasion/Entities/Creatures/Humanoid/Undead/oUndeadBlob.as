...
namespace ANybakk {
  ...
  class UndeadBlob {
    ...
    UndeadBlob(UndeadVariables pVariables) {
    ...
    void onDie(CBlob@ this) {
      ...
      server_DropCoins(this.getPosition() + Vec2f(0,-3.0f), mVariables.DROP_COIN_AMOUNT);
    ...
    bool isWithinChasingRange(CBlob@ this, CBlob@ target) {
      ...
      return Blob::getDistance(this, target) <= mVariables.BRAIN_CHASE_RADIUS;
    ...
    bool isWithinDetectionRange(CBlob@ this, CBlob@ target) {
      ...
      //Finished, return true if distance is within the combined radius
      return Blob::getDistance(this, target) <= mVariables.BRAIN_DETECT_RADIUS;
