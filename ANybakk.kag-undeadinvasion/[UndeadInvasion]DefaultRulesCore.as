...
namespace UndeadInvasion {
   ...
   */
  class DefaultRulesCore : ::RulesCore {
    ...
    UndeadInvasion::DefaultRespawnSystem@ mRespawnSystem;
    ...
    void Setup(CRules@ rules = null, RespawnSystem@ respawnSystem = null) override {
      ...
      @mRespawnSystem = cast<UndeadInvasion::DefaultRespawnSystem@>(respawnSystem);
    ...
    void Update() override {
      ...
      //Check if the game is currently active
        ...
        //Otherwise, there are still survivors
          ...
          if(Base::Rules::nightHasPassed(rules)) {
          ...
          } else if(!Base::Rules::isNightTime(rules)) {
        
            //Determine how many days have passed
            int dayNumber = Base::Rules::getDayNumber(rules);
