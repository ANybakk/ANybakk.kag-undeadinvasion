...
namespace UndeadInvasion {
  ...
  /**
   * RespawnSystem derivate
   * Represents the re-spawn functionality
   */
  class DefaultRespawnSystem : ::RespawnSystem {
    ...
    void Update() override {
      ...
      //if(g_debug > 0) { print("[UndeadInvasion::DefaultRespawnSystem::Update]"); }
    ...
    void AddPlayerToSpawn(CPlayer@ player) override {
      ...
      if(g_debug > 0) { print("[UndeadInvasion::DefaultRespawnSystem::AddPlayerToSpawn]"); }
    ...
    void RemovePlayerFromSpawn(CPlayer@ player) override {
      ...
      if(g_debug > 0) { print("[UndeadInvasion::DefaultRespawnSystem::RemovePlayerFromSpawn]"); }
    ...
    bool isSpawning(CPlayer@ player) override {
      ...
      //if(g_debug > 0) { print("[UndeadInvasion::DefaultRespawnSystem::isSpawning]"); }
    ...
    void DoSpawnPlayer(PlayerInfo@ playerInfo) override {
      ...
      //if(g_debug > 0) { print("[UndeadInvasion::DefaultRespawnSystem::DoSpawnPlayer]"); }
    ...
    bool canSpawnPlayer(PlayerInfo@ playerInfo) override {
      ...
      //if(g_debug > 0) { print("[UndeadInvasion::DefaultRespawnSystem::canSpawnPlayer]"); }
      ...
      return Base::Rules::isDayTime(core.rules);
    ...
    Vec2f getSpawnLocation(PlayerInfo@ playerInfo) override {
      ...
      //if(g_debug > 0) { print("[UndeadInvasion::DefaultRespawnSystem::getSpawnLocation]"); }
