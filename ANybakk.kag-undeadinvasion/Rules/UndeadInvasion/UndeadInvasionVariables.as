...
namespace UndeadInvasionVariables {
  ...
  const UndeadInvasionSpawnData[] UNDEAD_ENTITY_SPAWN_MIX = {
    UndeadInvasionSpawnData("Zombie", 60),                             //Zombie 60% chance
    UndeadInvasionSpawnData("Skeleton", 35),                           //Skeleton 35% chance
    UndeadInvasionSpawnData("Devilish Zombie", 5)                      //Devilish Zombie 5% chance
  };
